...
import madnessCharacter from '../assets/madness_character_modern.png'
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-8">
                <header className="space-y-4">
                  <a href="https://anansiportia.com" target="_blank" rel="noopener noreferrer" aria-label="Access MadnessBot AI-Powered Automotive Assistant">
                    <Badge className="bg-blue-600 text-white text-lg px-6 py-3 hover:bg-blue-700 transition-colors cursor-pointer">
                      <Zap className="w-6 h-6 mr-2" aria-hidden="true" />
                      AI-Powered Automotive Assistant
                    </Badge>
                  </a>
                  <h1 className="text-4xl lg:text-6xl font-bold leading-tight">
                    Your AI Master Mechanic
                    <span className="block text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400">
                      Available 24/7
                    </span>
                  </h1>
                  <p className="text-xl text-slate-300 leading-relaxed">
                    Get expert automotive advice, diagnose problems, provide repair estimates, and manage your toolbox with AI-powered precision.
                  </p>
                </header>
